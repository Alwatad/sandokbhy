...
// Seed data for initial Sandokbhy setup
...
export const seedProducts = [
  {
    ...
    description: 'This is a sample product for your Sandokbhy store.',
...
export const seedGlobals = {
  ...
  footer: {
    ...
    copyright: '© 2024 Sandokbhy. All rights reserved.',
  },
  settings: {
    siteName: 'Sandokbhy',
